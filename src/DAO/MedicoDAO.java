...
public class MedicoDAO {
    ...
    public void guardarMedico(Medico medicos) throws SQLException {
        String sql = "INSERT INTO medicos (nombre, apellido, direccion, telefono, especialidad) VALUES (?, ?, ?, ?, ?)";
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            stmt.setString(1, medicos.getNombre());
            stmt.setString(2, medicos.getApellido());
            stmt.setString(3, medicos.getDireccion());
            stmt.setString(4, medicos.getTelefono());
            stmt.setString(5, medicos.getEspecialidad());
            stmt.executeUpdate();
        }
    }
