...
public class PacienteDAO {
    ...
    public void guardarPaciente(Paciente pacientes) throws SQLException {
        ...
        try (PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            stmt.setString(2, pacientes.getApellido());
            stmt.setString(3, pacientes.getDireccion());
            stmt.setString(4, pacientes.getTelefono());
            stmt.setString(5, pacientes.getHistorialMedico());
            stmt.executeUpdate();
        }
    }
